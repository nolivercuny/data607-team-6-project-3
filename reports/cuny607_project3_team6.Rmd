...
## Load from database / create fact tables
```{r eval=TRUE}
...
Our analysis of technical skill frequency suggests that candidates are expected to be versed in Python, R and SQL as foundational skills.
